...
pub static CPU_OPS_CODES: LazyLock<HashSet<OpCode>> = LazyLock::new(|| {
    ...
    let contents = &[
        ...
        OpCode::new(0x49, EOR, 2, 3, ZeroPage),
        OpCode::new(0x49, EOR, 2, 4, ZeroPageX),
        OpCode::new(0x49, EOR, 3, 4, Absolute),
        OpCode::new(0x49, EOR, 3, 4, AbsoluteX),
        OpCode::new(0x49, EOR, 3, 4, AbsoluteY),
        OpCode::new(0x49, EOR, 2, 6, IndirectX),
        OpCode::new(0x49, EOR, 2, 5, IndirectY),
        // INC
